...
namespace IFILifeSupport
{
    ...
    public class IFILS2 : GameParameters.CustomParameterNode
    {
        ...
        public double RatePerKerbalPerMinute
        {
            get
            {
                return lsRatePerDay / IFI_LifeSupportTrackingDisplay.MINPERDAY; 
                //return lsRatePerDay / (60 * (GameSettings.KERBIN_TIME ? 6 : 24));
            }
        }

        [GameParameters.CustomIntParameterUI("Auto Warp Cancellation lead time (days)", minValue = 0, maxValue = 30,
